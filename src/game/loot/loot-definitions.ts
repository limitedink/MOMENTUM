...
export const COMBAT_LOOT_DEFINITIONS: readonly ItemDefinition[] = [
  ...
  armourBase('scout-helm', 'Scout Helm', 'helm', 'light', { hp: 12, dashCooldown: -0.08 }, 'quick-visor', 'Quick Visor', 'Dashing after a hit grants a brief accuracy bonus.'),
  armourBase('warden-helm', 'Warden Helm', 'helm', 'medium', { hp: 20, accuracy: 2 }, 'watchful-crown', 'Watchful Crown', 'Telegraphed attacks are easier to read.'),
  armourBase('citadel-helm', 'Citadel Helm', 'helm', 'heavy', { hp: 30, maxHit: 2 }, 'iron-brow', 'Iron Brow', 'The first stagger received each run is reduced.'),
  armourBase('trail-jacket', 'Trail Jacket', 'chest', 'light', { hp: 18, dashCooldown: -0.1 }, 'trailblazer', 'Trailblazer', 'Moving through a shockwave restores a little momentum.'),
  armourBase('frontier-mail', 'Frontier Mail', 'chest', 'medium', { hp: 28, accuracy: 1 }, 'steady-heart', 'Steady Heart', 'Taking damage does not interrupt the next attack wind-up.'),
  armourBase('apex-aegis', 'Apex Aegis', 'chest', 'heavy', { hp: 34, dashCooldown: 0.1 }, 'last-stand', 'Last Stand', 'Once per arena run, lethal damage leaves the player at 1 HP.', 'A plated mantle cut from the Apex frontier.'),
  armourBase('pathfinder-gloves', 'Pathfinder Gloves', 'gloves', 'light', { accuracy: 3, dashCooldown: -0.05 }, 'sure-grip', 'Sure Grip', 'A dash never drops the current aim.'),
  armourBase('forgebound-gloves', 'Forgebound Gloves', 'gloves', 'medium', { damage: 3, hp: 8 }, 'tempered-grip', 'Tempered Grip', 'The next attack after taking damage gains force.'),
  armourBase('bastion-gauntlets', 'Bastion Gauntlets', 'gloves', 'heavy', { damage: 5, hp: 15 }, 'crushing-guard', 'Crushing Guard', 'Blocking a shockwave empowers the next hit.'),
  armourBase('scout-pants', 'Scout Pants', 'pants', 'light', { hp: 14, dashCooldown: -0.12 }, 'free-stride', 'Free Stride', 'The first dash in a run has reduced cooldown.'),
  armourBase('warden-greaves', 'Warden Greaves', 'pants', 'medium', { hp: 24, range: 8 }, 'rooted-step', 'Rooted Step', 'Being hit while grounded grants a short ward.'),
  armourBase('citadel-cuisses', 'Citadel Cuisses', 'pants', 'heavy', { hp: 38, maxHit: 2 }, 'unyielding', 'Unyielding', 'The player cannot be staggered twice in quick succession.'),
  armourBase('trail-boots', 'Trail Boots', 'boots', 'light', { dashCooldown: -0.15, range: 5 }, 'windwalker', 'Windwalker', 'A successful dash briefly improves range.'),
  armourBase('march-boots', 'March Boots', 'boots', 'medium', { hp: 16, dashCooldown: -0.07 }, 'marching-song', 'Marching Song', 'The next attack after a dash has improved accuracy.'),
  armourBase('iron-tread', 'Iron Tread', 'boots', 'heavy', { hp: 27, maxHit: 3 }, 'grounded', 'Grounded', 'Shockwaves deal slightly less damage while grounded.'),
  armourBase('drift-cloak', 'Drift Cloak', 'cloak', 'light', { hp: 10, dashCooldown: -0.1, range: 10 }, 'afterimage', 'Afterimage', 'A dash leaves an afterimage that draws projectiles.'),
  armourBase('traveler-cloak', 'Traveler Cloak', 'cloak', 'medium', { hp: 20, accuracy: 2, range: 6 }, 'long-road', 'Long Road', 'The first attack in each encounter gains range.'),
  armourBase('nightwall-cloak', 'Nightwall Cloak', 'cloak', 'heavy', { hp: 32, dashCooldown: 0.08 }, 'nightwall', 'Nightwall', 'A cloak woven from the frontier night absorbs a hit.', 'A heavy cloak that turns aside hostile magic.'),
  ...
  accessoryBase('amulet-of-guarding', 'Amulet of Guarding', 'amulet', { hp: 18, bossDamage: 2 }, 'ward-oath', 'Ward Oath', 'A boss telegraph grants a brief ward.'),
